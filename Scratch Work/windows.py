...
class MyGame(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        ball = Ball(50, 50, 3, 3, 15, arcade.color.BRILLIANT_LAVENDER)
        self.ball_list.append(ball)

        ball = Ball(100, 150, 2, 3, 15, arcade.color.CHERRY_BLOSSOM_PINK)
        self.ball_list.append(ball)

        ball = Ball(150, 250, -3, -1, 15, arcade.color.BLIZZARD_BLUE)
        self.ball_list.append(ball)
